...
$backendProcess = Start-Process -FilePath "powershell" -ArgumentList "-NoExit", "-Command", "cd '$scriptPath\backend'; .\.venv\Scripts\uvicorn app.main:app --host 127.0.0.1 --port 8001 --reload" -PassThru
...
Write-Host "  • Backend API Docs: http://127.0.0.1:8001/docs" -ForegroundColor White
Write-Host "  • Neon DB Target:   ep-blue-glade-aybcwy7k-pooler.c-5.us-east-2.aws.neon.tech" -ForegroundColor White
Write-Host "  • LLM Engine:       Mistral AI (z7IEQV2dH7...)" -ForegroundColor White
